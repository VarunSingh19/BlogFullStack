    ...
    <footer className="bg-muted/40 border-t">
      <div className="container py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            ...
            <p className="text-muted-foreground mb-4 max-w-xs">
              A modern blog platform with AI-powered features, premium content, and a vibrant community.
            </p>
          ...
          <div>
            ...
            <div className="flex gap-2">
              <Input
                ...
                className="max-w-[220px] transition-all duration-200 focus:ring-2 focus:ring-primary/20"
              />
        ...
        <div className="border-t mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">© {new Date().getFullYear()} BlogHub. All rights reserved.</p>

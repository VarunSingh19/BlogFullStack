              ...
              <TabsContent value="saved">
                <Card className="border-2">
                  <CardHeader>
                    ...
                    <CardDescription>Manage your saved articles and PDFs</CardDescription>
                  </CardHeader>
                  <CardContent>
              ...
              <TabsContent value="transactions">
                <Card className="border-2">
                  <CardHeader>
                    ...
                    <CardDescription>View your purchase history and receipts</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="text-center py-12">
                      <p className="text-muted-foreground">You haven't made any purchases yet.</p>
                      <Button className="mt-4">Explore Premium Content</Button>
                    </div>
                  </CardContent>
                </Card>
              </TabsContent>
